...
## Disaggregating Participant- and Study-Level Effects

## Between-Study Heterogeneity of Means

## Between-Study Heterogeneity of Means and Participant-Level Effects

---

# Disaggregated Participant- and Study-Level Effects
...
+ Extend disaggregated regression model to model mean heterogeneity
...
+ Extend the disaggregated regression model to model mean heterogeneity
...
+ $\sigma^2_{u_0}$: between-study variance in study conditional means $\gamma_{00} + u_{0j}$
...
# Heterogeneity: Means and Participant Effects
...
+ Type I error rate for study-level effect affected by degree of mean heterogeneity
  + $\sigma^2_{u_0}$ needs to be modeled: FS MLM or RS MLM
...
+ Type I error rate for average participant-level fixed effect affected by degree of participant-level effect heterogeneity
  + $\sigma^2_{u_1}$ needs to be modeled: RS MLM
...
+ Carefully consider and model sources of between-study heterogeneity
  ...
  + Failing to do so can yield incorrect type I error rates for both kinds of fixed effects
...
+ Overall, MLM is a viable option for IDA with even as few as six studies
